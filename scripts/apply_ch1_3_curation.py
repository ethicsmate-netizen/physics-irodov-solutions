"""
apply_ch1_3_curation.py
Merge Chapter 1.3 curated batches (1.118 to 1.199) into data/questions_seed.json and data/irodov.db.
"""
...
# Import batches
from ch1_3_batch1 import CH1_3_BATCH_1
from ch1_3_batch2 import CH1_3_BATCH_2
from ch1_3_batch3 import CH1_3_BATCH_3

all_ch1_3 = CH1_3_BATCH_1 + CH1_3_BATCH_2 + CH1_3_BATCH_3
curated_map = {item['id']: item for item in all_ch1_3}
print(f"Loaded {len(curated_map)} curated Chapter 1.3 questions (1.118 to 1.199).")
...
print("Chapter 1.3 curation successfully applied!")
