"""
apply_ch1_5_curation.py
Merge Chapter 1.5 curated batches (1.234 to 1.289) into data/questions_seed.json and data/irodov.db.
"""
...
# Import batches
from ch1_5_batch1 import CH1_5_BATCH_1
from ch1_5_batch2 import CH1_5_BATCH_2

all_ch1_5 = CH1_5_BATCH_1 + CH1_5_BATCH_2
curated_map = {item['id']: item for item in all_ch1_5}
print(f"Loaded {len(curated_map)} curated Chapter 1.5 questions (1.234 to 1.289).")
...
print("Chapter 1.5 curation successfully applied!")
