"""
apply_ch1_7_curation.py
Merge Chapter 1.7 curated batch (1.315 to 1.339) into data/questions_seed.json and data/irodov.db.
"""
...
# Import Chapter 1.7
from ch1_7_curated import CH1_7_CURATED

curated_map = {item['id']: item for item in CH1_7_CURATED}
print(f"Loaded {len(curated_map)} curated Chapter 1.7 questions (1.315 to 1.339).")
...
print("Chapter 1.7 curation successfully applied!")
