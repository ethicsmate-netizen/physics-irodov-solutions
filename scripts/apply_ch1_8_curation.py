"""
apply_ch1_8_curation.py
Merge Chapter 1.8 curated batches (1.340 to 1.388) into data/questions_seed.json and data/irodov.db.
"""
...
# Import batches
from ch1_8_batch1 import CH1_8_BATCH_1
from ch1_8_batch2 import CH1_8_BATCH_2

all_ch1_8 = CH1_8_BATCH_1 + CH1_8_BATCH_2
curated_map = {item['id']: item for item in all_ch1_8}
print(f"Loaded {len(curated_map)} curated Chapter 1.8 questions (1.340 to 1.388).")
...
for q in questions:
    ...
    if qid in curated_map:
        ...
        # Ensure chapter title and id are correctly assigned to 1.8
        q['chapter_id'] = "1.8"
        q['chapter_title'] = "Relativistic Mechanics"
        updated_count += 1
...
print("Chapter 1.8 curation successfully applied!")
