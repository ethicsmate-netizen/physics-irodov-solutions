"""
apply_ch1_6_curation.py
Merge Chapter 1.6 curated batch (1.290 to 1.314) into data/questions_seed.json and data/irodov.db.
"""
...
# Import Chapter 1.6
from ch1_6_curated import CH1_6_CURATED

curated_map = {item['id']: item for item in CH1_6_CURATED}
print(f"Loaded {len(curated_map)} curated Chapter 1.6 questions (1.290 to 1.314).")
...
print("Chapter 1.6 curation successfully applied!")
