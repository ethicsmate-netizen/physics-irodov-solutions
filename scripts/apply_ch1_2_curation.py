"""
apply_ch1_2_curation.py
Merge Chapter 1.2 curated batches (1.59 to 1.117) into data/questions_seed.json and data/irodov.db.
"""
...
# Import batches
from ch1_2_batch1 import CH1_2_BATCH_1
from ch1_2_batch2 import CH1_2_BATCH_2

all_ch1_2 = CH1_2_BATCH_1 + CH1_2_BATCH_2
curated_map = {item['id']: item for item in all_ch1_2}
print(f"Loaded {len(curated_map)} curated Chapter 1.2 questions (1.59 to 1.117).")
...
print("Chapter 1.2 curation successfully applied!")
